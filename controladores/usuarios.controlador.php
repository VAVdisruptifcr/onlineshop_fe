...
class ControladorUsuarios{
	...
	public function ctrRegistroUsuario(){
		...
		if(isset($_POST["regUsuario"])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["regEmail"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){

			$encriptar = crypt($_POST["regPassword"], '$2a$07$usesomesillystringfore2uDLvp1Ii2e./U9C8sBjqp8I90dH6hi');

			$encriptarMail = md5($_POST["regEmail"]);
			...
			$mail->setFrom('funlav@gmail.com', 'Disruptifcr');

			$mail->addReplyTo('', 'No responder a esta comunicación');
			...
			$mail->msgHTML('<div style="width: 100%; background: #eee; position: relative; font-family: sans-serif; padding-bottom: 40px">
						...
						<center>
							...
							<img style="padding: 10px; width:10%" src="http://tutorialesatualcance.com/tienda/logo.png">
						...
						<div style="position: relative;	margin:auto; width: 600px; background:white; padding: 20px">
							...
							<center>
								...
								<a href="'.$url.'verificar/'.$encriptarMail.'" target="_blank" style="text-decoration:none">
								...
								<h5 style="font-weight:100; color:#999">Si no recuerda haberse suscrito a nuestra aplicación, ignore este correo y la cuenta se eliminará automáticamente por el sistema</h5>
					...
					if(!$envio){
						...
						echo '<script> 
							...
							swal({
								title: "¡'.$respuesta.'!",
								text: "Ha ocurrido algún problema enviando verificación de correo electrónico a '.$_POST["regEmail"].$mail->ErrorInfo.'",
								type: "error",
				...
				echo '<script> 
							...
							swal({
								title: "¡'.$respuesta.'!",
								text: "Registro de usuario no realizado, no se permiten caracteres especiales.",
								type: "error",
								confirmButtonText: "Cerrar",
								closeOnConfirm: false
							},
	...
	public function ctrIngresoUsuario(){
		...
		if(isset($_POST["ingEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["ingEmail"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				$encriptar = crypt($_POST["ingPassword"], '$2a$07$usesomesillystringfore2uDLvp1Ii2e./U9C8sBjqp8I90dH6hi');
				...
				if($respuesta["email"] == $_POST["ingEmail"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["verificacion"] == 1){
						...
						echo '<script> 
							...
							swal({
								  title: "¡NO HAZ VERIFICATO AÚN TU CUENTA!",
								  text: "'.'¡Por favor revise la bandeja de entrada o SPAM de tu correo '.$_POST["regEmail"].' y sigue las instrucciones para verificar la cuenta!",
								  type:"error",
								  confirmButtonText: "Cerrar",
								  closeOnConfirm: false
								},
					...
					echo '<script> 
							...
							swal({
								...
								text: "Por favor verifica que el correo y la contraseña coincidan con las utilizadas en el registro.",
								type: "error",
								confirmButtonText: "Cerrar",
								closeOnConfirm: false
							},
	...
	/*===========================================
	OLVIDO DE CONTRASEÑA RESET PASSWORD 
	=========================================== */ 
	...
	public function ctrOlvidoPassword(){
		...
		if(isset($_POST["passEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				$encriptar = crypt($nuevaPassword, '$2a$07$usesomesillystringfore2uDLvp1Ii2e./U9C8sBjqp8I90dH6hi');
				...
				if($respuesta1){
					...
					if($respuesta2 == "ok"){
						...
						$mail->Subject = "Solicitud de nueva contraseña para OnlineShop";
						...
						$mail->msgHTML('<div style="width: 100%; background: #eee; position: relative; font-family: sans-serif; padding-bottom: 40px">
								...
								<div style="position: relative;	margin:auto; width: 600px; background:white; padding: 20px">
									...
									<center>
										...
										<h4 style="font-weight: 100; color:#999; padding: 0 20px">Su actual contraseña:
											<strong> '.$nuevaPassword.' </strong>
										</h4>

										<a href="'.$url.'" target="_blank" style="text-decoration:none">
											<div style="line-height:60px; background:#0aa; width: 60%; color:white">Regresar al sitio</div>
										</a>
								...
								if(!$envio){
									...
									echo '<script> 
										...
										swal({
											title: "¡'.$respuesta.'!",
											text: "Ha ocurrido algún problema realizando el cambio de contraseña a '.$_POST["passEmail"].$mail->ErrorInfo.'",
											type: "error",
											confirmButtonText: "Cerrar",
											closeOnConfirm: false
										},
									...
									echo '<script> 
												...
												swal({
													  title: "¡OK!",
													  text: "'.'¡Por favor revise la bandeja de entrada o la carpeta de SPAM de su correo electrónico '.$_POST["passEmail"].' para finalizar el cambio de contraseña!",
													  type:"success",
													  confirmButtonText: "Cerrar",
													  closeOnConfirm: false
													},
				...
				echo '<script> 
							...
							swal({
								title: "¡ERROR!",
								text: "Error al enviar el correo electrónico. Dirección incorrecta.",
								type: "error",
								confirmButtonText: "Cerrar",
								closeOnConfirm: false
							},
		...
		if($respuesta0){
			...
			if($respuesta0["modo"] != $datos["modo"]){
				...
				echo '<script> 
							...
							swal({
								title: "¡ERROR!",
								text: "Error el correo electrónico '.$datos["email"].' ya se encuentra registrado con un método diferente a Google.",
								type: "error",
								confirmButtonText: "Cerrar",
								closeOnConfirm: false
							},
	...
	public function ctrActualizarPerfil(){
		...
		if(isset($_POST["editarNombre"])){
			...
			/*==========================================
			PREGUNTAREMOS SI EXISTE OTRA IMAGEN EN LA DB
			========================================== */
			...
			if($_POST["editarPassword"] == ""){
				...
				$password = crypt($_POST["editarPassword"], '$2a$07$usesomesillystringfore2uDLvp1Ii2e./U9C8sBjqp8I90dH6hi');
			...
			if($respuesta == "ok"){
				...
				echo '<script> 
							...
							swal({
								title: "¡'.$respuesta.'!",
								text: "Haz actualizado tus datos de perfil exitosamente!!!.",
								type: "success",
								confirmButtonText: "Cerrar",
								closeOnConfirm: false
							},
		...
		if(isset($_POST["idComentario"])){
			...
			if(preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["comentario"])){
					...
					if($respuesta == "ok"){
						...
						echo '<script> 
									...
									swal({
										...
										text: "Su calificación y comentarios han sido guardados!!!.",
										type: "success",
										confirmButtonText: "Cerrar",
										closeOnConfirm: false
									},
				...
				echo '<script> 
							...
							swal({
								title: "¡ERROR AL ENVIAR SU CALIFICACIÓN!",
								text: "El comentario no puede llevar caractéres especiales!!!.",
								type: "error",
								confirmButtonText: "Cerrar",
								closeOnConfirm: false
							},
	...
	static public function ctrAgregarDeseo($datos){
		...
		$respuesta = ModeloUsuarios::mdlAgregarDeseo($datos, $tabla);

		return $respuesta;
	}

	/*===================================
	MOSTRAR LISTA DE DESEOS EN PERFIL
	===================================*/
	...
	static public function ctrQuitarDeseo($datos){
		...
		$respuesta = ModeloUsuarios::mdlQuitarDeseo($datos, $tabla);
			...
			if($respuesta == "ok"){
				...
				echo '<script>
						...
						swal({
							...
							text: "Deberás registrarte nuevamente si desearas ingresar",
							type: "success",
							confirmButtonText: "Cerrar",
							closeOnConfirm: false
						},

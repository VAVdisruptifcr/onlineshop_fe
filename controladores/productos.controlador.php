...
class ControladorProductos{
	...
	/*=============================== 
	ACTUALIZAR VISTAS PRODUCTO
	=============================== */ 

	static public function ctrActualizarVistasProducto($datos, $item){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlActualizarVistasProducto($tabla,$datos,$item);

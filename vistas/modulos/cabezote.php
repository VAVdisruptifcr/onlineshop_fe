...
===================================== */ 
	...
	/* ================================================
	RECIBIMOS LA VARIABLE $_GET DE GOOGLE LLAMADA CODE
	================================================ */
									...
									if($_SESSION["modo"] == "directo"){
										...
										if($_SESSION["foto"] != ""){
											...
											echo '<li>
												...
												<img class="img-circle" src="'.$url.$_SESSION["foto"].'" width="10%" alt="">					
											...
											echo '<li>
												...
												<img class="img-circle" src="'.$server.'vistas/img/usuarios/default/anonymous.png" width="10%" alt="">
	...
	<div class="container">
		...
		========================-->
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="logotipo">
				<a href="<?php echo $url; ?>">
					<img src="<?php echo $server.$social['logo']; ?>" class="img-responsive" alt="">
				</a>
			</div>
		<!--=======================
        	...
        	<hr>
	        	<div class="form-group">
	        		...
	        		<div class="input-group">
						...
						<input type="text" id="regUsuario" class="form-control text-uppercase"  name="regUsuario" placeholder="Nombre completo" required>
        		...
        		<!-- =======================================================
				www.iubenda.com CONDICIONES DE USO Y POLÍTICAS DE PRIVACIDAD
        		======================================================== -->
				<div class="checkBox">
					...
					<label for="">
						...
						<input id="regPoliticas" type="checkbox">
							...
							<small>
								...
								Al registrarse acepta las condiciones de uso y políticas de privacidad.

								<br>
								<a href ="https://www.iubenda.com/privacy-policy/64771191" class="iubenda-white iubenda-embed " title="Privacy Policy">Leer más</a> 
  ...
  <div class="modal fade modalFormulario" id="modalIngreso" role="dialog">
    <div class="modal-content modal-dialog">
        ...
        <div class="modal-footer">
			...
			No haz creado aún tu cuenta, creala ahora | <strong><a href="#modalRegistro" data-dismiss="modal" data-toggle="modal">Registrarse</a></strong>
    ...
    <div class="modal-content modal-dialog">
        ...
        <div class="modal-body modalTitulo">
        	...
        	<form method="post">
        		...
        		<label class="text-muted" for="passEmail">Escribe el correo electrónico que usaste al registrarte en la aplicación</label>
        ...
        <div class="modal-footer">
			...
			No haz creado aún tu cuenta, creala ahora y haz tu pedido | <strong><a href="#modalRegistro" data-dismiss="modal" data-toggle="modal">Registrarse</a></strong>

	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
		  	...
		  	<li>
		  		...
		  		<a target="_blank" href="<?php echo $url; ?>ofertas">
		...
		<div class="tab-content">
					  					...
					  					<div class="panel-body">
					  						...
					  						<div class="col-md-2 col-sm-6 col-xs-12">
												...
												<figure>
													...
													<img class="img-thumbnail" src="'.$server.$value2["portada"].'" alt="">
					  						...
					  						<div class="col-sm-6 col-xs-12">
												...
												if($value2["tipo"] == "virtual"){
													...
													echo '<a href="'.$url.'/curso">
															<button class="btn btn-dafault pull-left">
																Ir al curso
															</button>
														</a>';
													...
													if($value1["envio"] == 0){
														...
														echo '<div class="progress">
																...
																<div class="progress-bar progress-bar-success" role="progressbar" style="width:33.33%">
																	<i class="fa fa-clock"></i>Entregado
																</div>
			...
			<!-- ==================================
			PESTAÑA LISTA DE DESEOS	TAB-PANE
			================================== -->
			...
			<?php 
				...
				if(!$deseos){
					...
					echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center error404">
							...
							<h2>Aún no tiene liste de deseos</h2>
									...
									echo '<li class="col-md-3 col-sm-6 col-xs-12">
												...
												echo '<h2 style="margin-top:-10px"> <small> Gratis </small> </h2>';
													...
													if($value2["oferta"] != 0){
														...
														echo '<h2 style="margin-top:-10px">
															...
															echo '<h2 style="margin-top:-10px"> <small>USD $'.$value2["descuentoOferta"].'</small> </h2>';
											...
											<div class="col-xs-6 enlaces">
												...
												<div class="btn-group pull-right">
													...
													<button type="button" class="btn btn-danger btn-xs quitarDeseo" idDeseo="'.$value1["id"].'" data-toggle="tooltip" title="Quitar de la lista de deseos">
													...
													if($value2["tipo"] == "virtual" && $value2["precio"] != 0){
														...
														if($value2["oferta"] != 0){
															...
															echo '<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="'.$value2["id"].'" imagen="'.$server.$value2["portada"].'"titulo="'.$value2["titulo"].'"precio="'.$value2["precioOferta"].'" tipo="'.$value2["tipo"].'" peso="'.$value2["peso"].'" data-toggle="tooltip" title="Agregar al carrito">
															...
															echo '<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="'.$value2["id"].'" imagen="'.$server.$value2["portada"].'"titulo="'.$value2["titulo"].'"precio="'.$value2["precio"].'" tipo="'.$value2["tipo"].'" peso="'.$value2["peso"].'" data-toggle="tooltip" title="Agregar al carrito">
			...
			<div id="perfil" class="tab-pane fade in">
			    ...
			    <div class="row">
								...
								echo '<input type="hidden" value="'.$_SESSION["id"].'" id="idUsuario" name="idUsuario">
									...
									if($_SESSION["modo"] == "directo"){
										...
										if($_SESSION["foto"] != ""){
											...
											echo '<img src="'.$url.$_SESSION["foto"].'" class="img-thumbnail" alt="">';

										}else{

											echo '<img src="'.$server.'vistas/img/usuarios/default/anonymous.png" class="img-thumbnail" alt="">';											
										}


									}else{

										echo '<img src="'.$_SESSION["foto"].'" class="img-thumbnail" alt="">';
									}
							...
							<?php 
								...
								if($_SESSION["modo"] != "directo"){
									...
									echo '<label class="control-label text-muted text-uppercase" for="editarNombre">Cambiar Nombre:</label>
										...
										<label class="control-label text-muted text-uppercase" for="editarEmail">Cambiar Email:</label>
			    	...
			    	<button class="btn btn-danger btn-md pull-right" name="eliminarUsuario" id="eliminarUsuario">Eliminar cuenta</button>	
...
================================= -->
<div id="modalComentarios" class="modal fade modalFormulario border-radius" role="dialog">

	<div class="modal-conten modal-dialog bg-warning">
		...
		<div class="modal-body modalTitulo">
			...
			<form method="post" onsubmit="return validarComentario()">
				...
				<div class="form-group">
					...
					<textarea class="form-control" row="5" name="comentario" id="comentario" maxlength="300" required></textarea>

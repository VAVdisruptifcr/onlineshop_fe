			...
			<div class="col-sm-6 col-xs-12">
				...
				<div class="btn-group">
					...
					<?php 
						...
						echo'<li><a href="'.$url.$rutas[0].'/1/recientes/'.$rutas[3].'">Lo reciente</a></li>
							<li><a href="'.$url.$rutas[0].'/1/antiguos/'.$rutas[3].'">Lo antiguo</a></li>';
...
<div class ="container-fluid productos">
	...
	<div class="container">
		...
		<div class="row">
			...
			/*=========================================================
			LLAMADO DE PRODUCTOS SEGÚN BUSQUEDA
			===========================================================*/
			$productos = null;
			$listaProductos = null;

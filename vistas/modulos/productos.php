			...
			<div class="col-sm-6 col-xs-12">
				...
				<div class="btn-group">
					...
					<?php 
						...
						echo'<li><a href="'.$url.$rutas[0].'/1/recientes">Lo reciente</a></li>
							<li><a href="'.$url.$rutas[0].'/1/antiguos">Lo antiguo</a></li>';
...
<div class ="container-fluid productos">
	...
	<div class="container">
		...
		<div class="row">
			...
			/*=========================================================
			LLAMADO DE PRODUCTOS DE CATEGORIAS, SUBCATEGORÍAS Y DETACADOS
			===========================================================*/
			...
			if(!$productos){
				...
				if($value["precio"] == 0){
					...
					echo '<h2>
						...
						echo '<h2> <small>USD $'.$value["precioOferta"].'</small> </h2>';
			...
			echo '<li class="col-xs-12">
					...
					<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
						...
						echo'<div class="btn-group pull-left enlaces">
							...
							<button type="button" class="btn btn-default btn-xs deseos" idProducto="'.$value["id"].'" data-toggle="tooltip" title="Ver producto">
								<i class="fa fa-heart" aria-hidden="true"></i>
							</button>';
